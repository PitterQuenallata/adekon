...
@section('contenido')
                                            ...
                                            <table id="tablas scroll-horizontal-datatable"
                                                ...
                                                <tbody>
                                                    @foreach ($disenos as $diseno)
                                                        <tr>
                                                            <td>{{ $diseno->id_diseño}}</td>
                                                            <td>{{ $diseno->nombre_diseño}}</td>
                                                            <td>
                                                                <button type="button"
                                                                    class="btn btn-warning waves-effect waves-light btnEditarDiseno"
                                                                    data-bs-toggle="modal" data-bs-target="#EditarDiseno"
                                                                    idDiseno="{{$diseno->id_diseño}}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Agregar Nueva Diseño</h4>
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="field-1" class="form-label">Nombre Diseño</label>
                                    <input type="text" class="form-control" id="field-1"
                                        placeholder="Ingrese nombre de Diseño" name="nuevoDiseno">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="EditarDiseno" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{ url('Actualizar-Diseño') }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="field-1" class="form-label">Nombre Diseño</label>
                                    <input type="text" class="form-control" id="editarDiseno" name="editarDiseno"
                                        required>
                                    <input type="text" class="form-control" id="idEditar" name="id_diseno" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
